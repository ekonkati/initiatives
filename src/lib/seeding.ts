...
const initiativesRaw = [
  ...
  { id: '5', name: 'Contract Lifecycle Management (CLM) Tool', category: 'Legal', description: 'Select and implement a CLM tool.', objectives: 'Automate contract creation, approval, and storage.', leadIds: ['user-5'], teamMemberIds: ['user-12', 'user-10', 'user-1'], status: 'Not Started', priority: 'Medium', startDate: '2024-07-20T00:00:00Z', endDate: '2025-02-20T00:00:00Z', tags: ['Legal', 'Automation', 'Digital'], ragStatus: 'Red', progress: 0 },
];
